...
define(['react', "react-redux","components/header","components/common/img",
	...
	class Club extends React.Component {
		...
		render() {
			return ( 
				React.createElement("div", {className: "club"}, 
					React.createElement(Header, null, 
						React.createElement("h1", {className: "mui-title"}, 
							"同事圈"
						), 
						React.createElement("a", {className: "mui-action-menu mui-icon clubfriends icon--xiangjicopy2x mui-pull-right", href: "#createPopover"})
					), 
					React.createElement("div", {id: "refreshContainer", className: "mui-content"}, 
						React.createElement("div", {className: "mui-scroll"}), 
						React.createElement("ul", {className: "twt_list"}, 
					this.props.list.map(function(item, index){
						var img_arr = JSON.parse(item.image);
						return (
							React.createElement("li", {className: "twt_item", "data-index": index}, 
								React.createElement("div", {className: "avatar"}, 
									React.createElement(Img, {placeholder: "./js/containers/img/60x60.gif", src: item.avatar, folder: "avatar"})
								), 
								React.createElement("div", {className: "body"}, 
									React.createElement("h3", null, 
										item.nick, 
									item.visiblity && this.state.visibility.length>0 ? 
										React.createElement("i", {className: "visibility clubfriends "+this.state.visibility[item.visiblity].icon})
									: null
									), 
									React.createElement("p", {dangerouslySetInnerHTML: {__html: $.replace_em(item.content)}}), 
								img_arr.length>0 && img_arr[0].length>0?
									...
									img_arr.map(function(item2, index2){
										...
										return (
										React.createElement("div", {className: "img", style: {width: width}}, 
											React.createElement(Img, {placeholder: "./js/containers/img/60x60.gif", src: item2, folder: "twitter"})
										)
										)
									}.bind(this))
									)
								...
								item.link_title?
									React.createElement("div", {className: "link_box"}, 
										React.createElement("h4", null, item.link_title)
									)
								:null, 
									React.createElement("div", {className: "oprate_box"}, 
										React.createElement("i", {className: "create_ts"}, item.create_time), 
										React.createElement("a", {className: "reply"}, "回复"), 
								...
								item.comment.map(function(item2, index2){
									return(
										React.createElement("div", {className: "comment", "data-index": index2}, 
											React.createElement("div", {className: "nick"}, item2.uid==this.props.uid?"我":item2.nick), 
											React.createElement("div", {className: "content"}, item2.content)
										)
									)
								}.bind(this))
									)
					...
					React.createElement("div", {id: "createPopover", className: "mui-popover"}, 
					  React.createElement("ul", {className: "mui-table-view"}, 
					    React.createElement("li", {className: "mui-table-view-cell create_say"}, "记录生活"), 
					    React.createElement("li", {className: "mui-table-view-cell take_photo"}, "拍照"), 
					    React.createElement("li", {className: "mui-table-view-cell choose_galary"}, "从相册选择"), 
					    React.createElement("li", {className: "mui-table-view-cell create_url"}, "分享文章")
					  )
					), 
