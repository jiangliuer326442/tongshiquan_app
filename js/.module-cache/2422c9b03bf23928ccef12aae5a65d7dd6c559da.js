...
define(['react', "react-redux", "config/index",
	...
	class Company extends React.Component {
		...
		componentDidMount(){
			...
			//通知管理
			if(mui.os.android){
				var NotificationManagerCompat = plus.android.importClass("ndroid.app.NotificationManagerCompat");
				var Context = plus.android.importClass("android.content.Context");
				var manager = plus.android.invoke(NotificationManagerCompat, "from", Context);
