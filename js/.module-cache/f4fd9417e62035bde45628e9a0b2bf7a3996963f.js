...
define(['react', "react-redux",
	...
	class Login extends React.Component {
		...
		render(){
			return ( 
			 	React.createElement("div", {className: "reglogin login"}, 
		 			React.createElement("div", {className: "head"}, 
		 				React.createElement("img", {onClick: function(){mui.back()}, className: "return", src: "./js/containers/register/img/return.png"})
		 			), 
		 			React.createElement("h2", {className: "title"}, "账号登录"), 
		 			React.createElement("div", {className: "inputbox phonebox mui-input-row"}, 
		 			this.state.focus||this.state.phone?
		 				React.createElement("div", {className: "msg "+(this.state.focus?"on":""), id: "msg1"}, "手机号码")
		 			:null, 
			  			React.createElement("input", {onChange: this.handleChange.bind(this), onFocus: this.handleFocus.bind(this), className: (this.state.focus?"on":"")+" mui-input-clear", ref: "phone_input", value: this.state.phone, type: "number", placeholder: "手机号码"})
		 			), 
		 			React.createElement("div", {className: "inputbox passwordbox mui-input-row mui-password"}, 
		 			!this.state.focus?
		 				React.createElement("div", {className: "msg mui-input-clear "+(!this.state.focus?"on":""), id: "msg2"}, "请输入密码")
		 			:null, 
			  			React.createElement("input", {onChange: this.handleChange.bind(this), onFocus: this.handleFocus.bind(this), className: (!this.state.focus?"on":"")+" mui-input-password", ref: "password_input", value: this.state.password, type: "password", placeholder: "请输入密码"})
		 			), 
		 			React.createElement("button", {ref: "loginbtn", className: this.state.phone.length == 11 && this.state.password.length>=6?"btn":"btn btngray", type: "mutton"}, "登录"), 
