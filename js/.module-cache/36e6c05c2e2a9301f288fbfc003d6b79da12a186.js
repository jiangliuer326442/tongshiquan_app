	...
	class Company extends React.Component {
		...
		componentDidMount(){
			...
			if(mui.os.android){
				...
				plus.android.invoke( intent, "setAction", Settings.APPLICATION_DETAILS_SETTINGS);
				//plus.android.invoke( intent, "putExtra", "app_package", plus.android.invoke(main, "getPackageName"));
