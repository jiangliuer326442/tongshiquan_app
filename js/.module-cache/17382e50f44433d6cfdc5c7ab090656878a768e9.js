	...
	class Company extends React.Component {
		...
		componentDidMount(){
			...
			if(mui.os.android){
				...
				var mAppOps = plus.android.invoke(Context, "getSystemService", Context.APP_OPS_SERVICE);
				var appInfo = plus.android.invoke(Context, "getApplicationInfo");
				var pkg = plus.android.invoke(Context, "getPackageName");
				var uid = plus.android.getAttribute(appInfo, "uid"); 
				console.log(uid);
				
//var isOpened = manager.areNotificationsEnabled();
return;
