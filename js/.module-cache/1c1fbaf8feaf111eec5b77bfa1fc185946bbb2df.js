	...
	class Company extends React.Component {
		...
		componentDidMount(){
			...
			if(mui.os.android){
				...
				alert(plus.android.invoke(Context, "getPackageName"));
				plus.android.invoke(intent,"setAction","android.settings.APP_NOTIFICATION_SETTINGS");
				plus.android.invoke(intent,"putExtra","android.provider.extra.APP_PACKAGE", plus.android.invoke(Context, "getPackageName"));
			}
