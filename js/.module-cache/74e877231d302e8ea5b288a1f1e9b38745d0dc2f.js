							...
							React.createElement("div", {className: "mui-scroll"}, 
								React.createElement("ul", {className: "mui-table-view mui-table-view-chevron"}, 
									React.createElement("li", {className: "mui-table-view-cell"}, 
										React.createElement("a", {className: "mui-navigate-right", href: ""}, React.createElement("i", {className: "mui-icon clubfriends icon--ttpodicon"}), "更换手机号")
									), 
									React.createElement("li", {className: "mui-table-view-cell"}, 
										React.createElement("a", {className: "mui-navigate-right", href: ""}, React.createElement("i", {className: "mui-icon clubfriends icon--ttpodicon"}), "修改密码")
									)
								), 
								React.createElement("ul", {className: "mui-table-view mui-table-view-chevron"}, 
									React.createElement("li", {className: "mui-table-view-cell"}, 
										React.createElement("a", {className: "mui-navigate-right", href: ""}, React.createElement("i", {className: "mui-icon clubfriends icon--ttpodicon"}), "不看Ta的动态")
									), 
									React.createElement("li", {className: "mui-table-view-cell"}, 
										React.createElement("a", {className: "mui-navigate-right", href: ""}, React.createElement("i", {className: "mui-icon clubfriends icon--ttpodicon"}), "不让Ta看我的动态")
									)
								)
							)
						)
