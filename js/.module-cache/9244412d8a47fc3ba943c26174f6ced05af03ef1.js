	...
	class Company extends React.Component {
		...
		componentDidMount(){
			...
			if(mui.os.android){
				...
				alert(plus.android.invoke(main, "getPackageName"));
				
				var Settings = plus.android.importClass('android.provider.Settings');
				var intent = new Intent();//可设置表中所有Action字段
				plus.android.invoke( intent, "setAction", Settings.APP_NOTIFICATION_SETTINGS);
				plus.android.invoke( intent, "app_package", "com.yelun.companyclub");
