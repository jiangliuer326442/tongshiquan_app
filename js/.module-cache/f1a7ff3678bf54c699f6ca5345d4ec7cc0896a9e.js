...
define(['react', "react-redux", "config/index",
	...
	class Discuz extends React.Component {
		...
		render() {
			return ( 
				React.createElement("div", {className: "discuz"}, 
					React.createElement(DisHeader, {companyid: this.props.params.companyid}), 
			this.props.selected_bar>=0?
					React.createElement("div", {className: "postbarbox"}, 
						React.createElement("div", {className: "logo"}, 
							React.createElement("img", {src: this.props.postbars[this.props.selected_bar].logo})							
						), 
			...
			:null, 
					React.createElement("div", {id: "refreshContainer", style: {marginTop: this.props.selected_bar==-1?"40px":"10px"}, className: "posts"}, 
					...
					this.props.posts.map(function(item, index){
						return (
							React.createElement("div", {"data-id": item.id, "data-uid": item.userid, "data-title": item.title, "data-avatar": item.user_avatar, "data-nick": this.props.selected_bar>=0?item.user_nick:item.user_name, "data-time": item.showtime, className: "post mui-card"}, 
								React.createElement("div", {className: "mui-card-header mui-card-media"}, 
									React.createElement(Img, {src: item.user_avatar, placeholder: "./js/containers/img/60x60.gif", folder: "avatar"}), 
									React.createElement("div", {className: "mui-media-body"}, 
										this.props.selected_bar>=0?item.user_nick:item.user_name, 
										React.createElement("p", null, "发表于 "+item.showtime)
									)
								), 
								React.createElement("div", {className: "mui-card-content"}, 
									React.createElement("div", {className: "mui-card-content-inner"}, 
										item.title
									)
								), 
								React.createElement("div", {className: "mui-card-footer"}, 
									React.createElement("span", {className: "readtimes"}, "阅读（"+item.readtimes+"）"), 
									React.createElement("span", {className: "commenttimes"}, "评论（"+item.commenttimes+"）")
								)
							)
						)
					}.bind(this))
