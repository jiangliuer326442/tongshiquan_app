...
define(['react', "react-redux","components/header",
	...
	class Create extends React.Component {
		...
		render(){
			return(
			React.createElement("div", {className: "club_create"}, 
				this.state.event_type==4?
				React.createElement("div", {className: "event_4"}, 
					React.createElement(Header, null, 
						...
						React.createElement("a", {className: "mui-icon mui-pull-right seturl"}, "确认")
					), 
					React.createElement("h4", {className: "desc"}, "请输入需要分享的文章URL"), 
					React.createElement("input", {ref: "url_content", type: "url", placeholder: "完整url，http或https开头"}), 
					React.createElement("section", {className: "qaarea"}, 
						React.createElement("h4", {className: "question"}, "Q:如何分享微信文章到同事圈?"), 
						React.createElement("p", {className: "answer"}, 
							"在微信文章的详情页,点击右上角图标,在弹出的界面中,点击复制链接,即可获得文章的地址,粘贴到这里就行啦!^_^", 
							React.createElement("img", {src: "./js/containers/club/img/share.jpg"})
						)
					)
				)
				:
				React.createElement("div", null, 
					React.createElement(Header, null, 
						...
						React.createElement("a", {className: "mui-icon mui-icon-arrowthinleft mui-action-back mui-pull-left"}), 
						React.createElement("a", {className: "mui-icon mui-pull-right submit"}, "发送")
					), 
					...
					this.state.list.length>0?
						React.createElement("div", {className: "body"}, 
							React.createElement("input", {type: "hidden", ref: "visible", defaultvalue: this.state.list[0].id}), 
							React.createElement("span", {className: "nick"}, this.props.uname), 
							React.createElement("span", {className: "visible"}, 
								React.createElement("i", {className: "clubfriends "+this.state.list[0].icon}), 
					...
					React.createElement("section", {className: "tbody"}, 
						React.createElement("p", {id: "display", 
							...
							}}, this.state.init_content), 
					this.state.link_info.title.length>0?
						React.createElement("div", {className: "link_box"}, 
							React.createElement("h4", null, this.state.link_info.title)
						)
					:null, 
					...
					this.state.upload_pics.map(function(item, index){
						return (
							React.createElement("img", {src: item.path, className: item.upload_flg?"":"unupload"})
						)
					}.bind(this)), 
							React.createElement("div", {className: "image-up"})
						)
					:null, 
						React.createElement("textarea", {id: "saytext"}, this.state.content)
					), 
					React.createElement("section", {className: "footer mui-bar-tab"}, 
						React.createElement("span", {id: "emotion", className: "mui-icon clubfriends icon--biaoqing"}), 
						React.createElement("span", {id: "camera", className: "mui-icon clubfriends icon--xiangjicopy2x", style: this.state.event_type == 1 && this.state.link_info.url.length>0 ? {display: "none"}: {display: "block"}}), 
						React.createElement("span", {id: "pics", className: "mui-icon clubfriends icon--tupian", style: this.state.event_type == 1 && this.state.link_info.url.length>0 ? {display: "none"}: {display: "block"}})
					)
				)
