...
define(['react','jquery','jquery-browser','jquery-qqface','css!./css/commentbox'], function(React, jQuery){
	class CommentBox extends React.Component {
		...
		render(){
			return (
				React.createElement("nav", {className: "mui-bar mui-bar-tab discuss_footer", style: this.state.comment_focus?{paddingRight:"0px"}:null}, 
					React.createElement("pre", {id: "comment_content"}), 
					React.createElement("div", {className: "comment_area"}, 
						...
						this.state.comment_focus || this.state.comment_content!=""?
							React.createElement("span", {id: "emotion", style: {marginLeft:"0px"}, className: "icon clubfriends icon--biaoqing"})
						:null
						), 
					this.state.comment_focus || this.state.comment_content!=""?
						...
						}.bind(this), className: "mui-btn mui-btn-primary mui-btn-outlined "+(this.state.comment_content.length>0?"":"gray")}, "发送")
					:
						React.createElement("a", {id: "emotion", role: "button", className: "btn btn-default", href: "javascript:;"}, 
							React.createElement("span", {className: "icon clubfriends icon--face"})
						)
