...
define(['react', "react-redux","actions/common","config/index","actions/nav","actions/reglog","actions/myuser",'css!./css/thirdlogin'], function(React, ReactRedux, common, config, nav, reglog,myuser){
	class ThirdLogin extends React.Component {
		...
		render(){
			return (
				React.createElement("div", {className: "thirdlogin"}, 
					React.createElement("h5", null, "快速登陆"), 
					React.createElement("div", {className: "loginicon"}, 
					this.state.wx_flg?
						React.createElement("div", {className: "mui-icon mui-icon-weixin"})
					:null, 
					this.state.qq_flg?
						React.createElement("div", {className: "mui-icon mui-icon-qq"})
					:null
					)
				)
			)
