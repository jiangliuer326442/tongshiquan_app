...
define(['react', "react-redux","wangeditor","config/index","components/header","actions/article","css!./css/createarticle"], function(React, ReactRedux, E, config, Header, article){
	...
	class CreateArticle extends React.Component {
		...
		render(){
			return (
				<div id="createarticle" className="createarticle mui-page">
					<header className="mui-navbar-inner mui-bar mui-bar-nav">
						...
						<button type="button" className="createarticle-triggler mui-btn mui-btn-primary  mui-pull-right">发表</button>
					</header>
					<div className="mui-content">
						...
						<div className="row mui-input-row">
							<input type="text" ref="title" onChange={this.handleChange1.bind(this)} onFocus={this.handleFocus1.bind(this)} onBlur={this.handleBlur1.bind(this)} value={this.state.title} placeholder="文章标题" />
						</div>
						:null}	
						{!this.state.keyboard_flg?
					    <p>文章简介</p>
					    ...
					    <div className="row mui-input-row desc">
							<textarea ref="desc" onChange={this.handleChange2.bind(this)} onFocus={this.handleFocus2.bind(this)} onBlur={this.handleBlur2.bind(this)} placeholder="简单说明一下文章主旨">{this.state.desc}</textarea>
					    </div>
					    :null}
						{!this.state.keyboard_flg?
					    <p>文章内容</p>
						...
						<div className="editarea">
							<div className="toolbar" style={this.state.keyboard_flg && !this.state.title_flg && !this.state.desc_flg?{position: "fixed",top:"50",zIndex:"3"}:{}} />
							<div className="editor" style={this.state.keyboard_flg && !this.state.title_flg && !this.state.desc_flg?{marginTop:"32px",height:(plus.android.invoke(plus.android.currentWebview(),"getHeight")/plus.screen.scale-35)+"px"}:{}}>
							</div>
						</div>
					</div>
				</div>
