	...
	class ChatDetail extends React.Component {
		...
		render() {
			return ( 
				<div className="chat">
					<Header>
						<a className="mui-action-back mui-icon mui-pull-left">返回</a>
						<h1 className="mui-title">{this.state.talk_nick}</h1>
						<a className="mui-icon mui-icon-person mui-pull-right"></a>
					</Header>
					<pre id='h'></pre>

					<footer>
						<div className="footer-left">
							<i id='msg-image' className="mui-icon mui-icon-camera" style={{fontSize: "28px"}}></i>
						</div>
						<div className="footer-center">
							<textarea id='msg-text' type="text" className='input-text'></textarea>
							<button id='msg-sound' type="button" className='input-sound' style={{display: "none"}}>按住说话</button>
						</div>
						<label htmlFor="" className="footer-right">
							<i id='msg-type' className="mui-icon mui-icon-mic"></i>
						</label>
					</footer>
					<div id='sound-alert' className="rprogress">
						<div className="rschedule"></div>
						<div className="r-sigh">!</div>
						<div id="audio_tips" className="rsalert">手指上滑，取消发送</div>
					</div>
				</div>
			)
		}
